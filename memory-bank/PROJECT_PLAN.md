...
- **المهام:**
    ...
    3.  **[x] تطوير ميزة تحليل GS1-128 الذكي (2025-11-29):**
        ...
        - [x] توثيق شامل للميزة
        - [ ] اختبار ميزة GS1-128 بعد تشغيل migration
    4.  **[x] تحسينات صفحة الفواتير المتقدمة (2026-01-14):**
        ...
        - [ ] تشغيل migration: add_gtin_product_mapping.sql
    ...
    6.  **[ ] تطوير واجهة إضافة مخزون مجمّع:** إنشاء واجهة جديدة تسمح بإضافة عدة أصناف مخزون دفعة واحدة.
    7.  **[x] ربط التقارير بالبيانات الحية:** التأكد من أن جميع التقارير تعمل بشكل ديناميكي مع Supabase.
    8.  **[ ] كتابة الاختبارات (Testing).**
