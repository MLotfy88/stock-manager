...
- **المهام:**
    ...
    2.  **[ ] تحسين دعم الباركود للأقواس والمسافات والشرطات:** تم التراجع عن توسيع قائمة تنسيقات الباركود المدعومة في `useBarcodeScanner.ts` بناءً على طلب المستخدم.
    3.  **[ ] معالجة خطأ عدم دعم Barcode Detector API:** تم التراجع عن التعديلات التي تهدف إلى معالجة هذا الخطأ بناءً على طلب المستخدم.
