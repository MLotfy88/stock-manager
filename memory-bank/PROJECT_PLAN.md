...
- **المهام:**
    ...
    2.  **[x] إضافة محلل باركود GS1-128:** تم تعديل `useBarcodeScanner.ts` لإضافة دالة `parseGS1Barcode` التي تقوم بتحليل البيانات الخام من باركود GS1-128 وإعادة تنسيقها بالشكل الصحيح مع الأقواس ومعرفات التطبيق (AIs).
    3.  **[x] بناء واجهة تقارير موحدة:** إعادة تصميم صفحة التقارير لتجميع كل التقارير (جرد، حد الطلب، استهلاك) في واجهة واحدة مع تبويبات. (تم إعادة تصميمها كمركز للتقارير مع تحسينات كبيرة لتقرير الجرد).
    5.  **[ ] تطوير واجهة إضافة مخزون مجمّع:** إنشاء واجهة جديدة تسمح بإضافة عدة أصناف مخزون دفعة واحدة.
    6.  **[x] ربط التقارير بالبيانات الحية:** التأكد من أن جميع التقارير تعمل بشكل ديناميكي مع Supabase. (تم التحقق والتأكيد خلال عملية إعادة التصميم).
