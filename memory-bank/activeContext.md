...
4.  **Frontend Validation & UX**
    ...
    *   **Auto-Save Drafts**: Implemented auto-save functionality in `AddSupplyPage`. Drafts are saved/updated automatically in the background (debounced). "Save Invoice" now finalizes the draft. Added draft loading logic for resuming work.
