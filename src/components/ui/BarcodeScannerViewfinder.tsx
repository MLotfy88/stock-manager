...
export const BarcodeScannerViewfinder = () => {
  return (
    <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
      <div className="relative w-3/4 max-w-md h-1/2 animate-pulse-border rounded-lg">
        {/* Overlay */}
        <div 
        ...
        {/* Laser line */}
        <div className="absolute top-0 bottom-0 left-1/2 w-0.5 bg-red-500 animate-laser-scan"></div>
      </div>
    </div>
  );
};
